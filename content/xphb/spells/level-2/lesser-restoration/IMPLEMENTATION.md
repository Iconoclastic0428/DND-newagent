...
## Source of Truth
- normalized source id: XPHB:spell:lesser-restoration
...
- which shared runtime primitives it reuses: ConditionRemovalEffectDef.
...
- active-effect lifecycle: Ends one of the supported blinded, deafened, paralyzed, or poisoned conditions on the touched creature.
...
- If no --condition is supplied, the runtime removes the first currently present supported condition in the allowed list order.
...
## Dependencies
- shared primitives required: ConditionRemovalEffectDef.
