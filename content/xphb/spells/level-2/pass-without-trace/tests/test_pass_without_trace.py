...
ITEM_ROOT = ROOT / 'content' / 'xphb' / 'spells' / 'level-2' / 'pass-without-trace'
SPELL_NAME = 'Pass without Trace'
SPELL_SLUG = 'pass-without-trace'
CAST_SYNTAX = '/cast player-1 pass-without-trace'
BLOCKER = 'Exact Pass without Trace needs a no-tracks / trail-suppression consumer; the current runtime has the stealth bonus primitive but no authoritative track suppression primitive.'


class PasswithoutTraceBlockedContractTests(unittest.TestCase):
