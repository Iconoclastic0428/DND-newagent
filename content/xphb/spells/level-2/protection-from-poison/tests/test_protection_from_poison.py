...
ITEM_ROOT = ROOT / 'content' / 'xphb' / 'spells' / 'level-2' / 'protection-from-poison'
SPELL_NAME = 'Protection from Poison'
SPELL_SLUG = 'protection-from-poison'
CAST_SYNTAX = '/cast player-1 protection-from-poison player-1'
BLOCKER = 'Exact Protection from Poison needs source-aware poison-save advantage plus poison-condition cleanup; the current runtime does not have a poison-specific save hook without guessing.'


class ProtectionfromPoisonBlockedContractTests(unittest.TestCase):
