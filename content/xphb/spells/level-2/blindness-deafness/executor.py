...
from shared_types.capabilities import (
    ...
    ParameterizedConditionEffectDef,
                ...
                SaveGateEffect(
                    ...
                    on_failure=(
                        ParameterizedConditionEffectDef(
                            ...
                            allowed_condition_types=(ConditionType.BLINDED, ConditionType.DEAFENED),
                            concentration=False,
                            replace_existing_same_name_from_source=False,
                            source_label='blindness/deafness',
                            ongoing_triggers=(
                                OngoingTriggerDefinition(
