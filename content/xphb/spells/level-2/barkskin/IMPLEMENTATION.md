...
## Source of Truth
- normalized source id: XPHB:spell:barkskin
...
- which shared runtime primitives it reuses: ActiveEffectDefinition armor_class_base_override.
...
- active-effect lifecycle: Applies an AC floor of 17 for 1 hour to the touched willing-creature surrogate target.
...
- The current targeting model uses ally-affinity as the willing-creature surrogate, so hostile targets are rejected.
...
## Dependencies
- shared primitives required: ActiveEffectDefinition armor_class_base_override.
