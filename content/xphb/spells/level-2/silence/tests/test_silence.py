...
ITEM_ROOT = ROOT / 'content' / 'xphb' / 'spells' / 'level-2' / 'silence'
SPELL_NAME = 'Silence'
SPELL_SLUG = 'silence'
CAST_SYNTAX = '/cast player-1 silence 5 2'
BLOCKER = 'Exact Silence needs an authoritative sound-blocking area that can suppress verbal casting and hearing-based effects.'


class SilenceBlockedContractTests(unittest.TestCase):
