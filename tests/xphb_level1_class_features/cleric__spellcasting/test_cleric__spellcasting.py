...
class ClericSpellcastingFeatureTestsTests(Level1ClassFeatureTestCase):
    def test_feature_name_is_recorded_in_the_character_record(self) -> None:
        record = self.complete_record('cleric')
    ...
    def test_compiled_actor_has_spellcasting_stats_and_slots(self) -> None:
        ...
        self.assertEqual(actor.spellcasting_ability, Ability.WIS)
