...
class WizardSpellcastingFeatureTestsTests(Level1ClassFeatureTestCase):
    def test_feature_name_is_recorded_in_the_character_record(self) -> None:
        record = self.complete_record('wizard', assign_command='/create ability assign 8 14 13 15 12 10')
    ...
    def test_compiled_actor_has_spellcasting_stats_and_slots(self) -> None:
        ...
        self.assertEqual(actor.spellcasting_ability, Ability.INT)
